const CACHE='mngr-v2.7.0-last-week';
const ASSETS=['./','./index.html','./styles.css?v=2.7.0','./app.js?v=2.7.0','./firebase-config.js?v=2.7.0','./manifest.json','./icons/icon-192.png','./icons/icon-512.png'];
